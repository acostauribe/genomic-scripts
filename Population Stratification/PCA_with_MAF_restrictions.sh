###NOV2019: Juliana A. Uribe
###All rights reserved
### Copyright: UCSB.

#!/bin/bash
# Script to perform a PCA analysis using PLINK and smartpca2.perl
...
PREFIX=CLM-909.QC.probands #Give prefix of the plink files
HIGHMAF=0.05 # maximum maf to include snps, if you dont wat a max-maf set value to 1
LOWMAF=0.01 # maf to include snps, if you dont wat a maf set value to 0
